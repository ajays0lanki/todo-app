...
def index(request):
    ...
    context={ 'todos': get_showing_todos(request,todos),'all_count':all_count,'incomplete_count': incomplete_count , 'completed_count':completed_count}
...
def create_todo(request):
    ...
    if request.method=="POST":
        ...
        todo.save()
        messages.add_message(request,messages.SUCCESS,"Todo created sucess ")
...
def todo_delete(request,id):
    ...
    if request.method == "POST":
        if todo.owner== request.user:
            todo.delete()
            messages.add_message(request,messages.SUCCESS,"Todo deleted sucess ")
...
def todo_edit(request,id):
    ...
    if request.method=="POST":
        ...
        if todo.owner== request.user:
            ...
            todo.save()
        messages.add_message(request,messages.SUCCESS,"Todo update sucess ")
